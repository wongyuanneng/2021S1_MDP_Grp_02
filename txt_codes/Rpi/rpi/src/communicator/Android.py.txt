...
#import logging
from src.config import ANDROID_SOCKET_BUFFER_SIZE, LOCALE, RFCOMM_CHANNEL, UUID, LOGSDIR
...
class Android:
    def __init__(self):
        #logging.basicConfig(filename = LOGSDIR+'and.log', format = '%(asctime)s: %(message)s', filemode='w')

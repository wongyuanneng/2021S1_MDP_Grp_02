...
from src.config import STOPPING_IMAGE, IMAGE_WIDTH, IMAGE_HEIGHT, IMAGE_FORMAT, LOGSDIR
...
class MultiProcessComms:
    ...
    def __init__(self, image_processing_server_url: str=None):
        ...
        if image_processing_server_url is not None:
            ...
            self.image_capture_queue = self.manager.Queue()
                ...
                for message in message_list:
                    ...
                    if len(message) <= 0:
                        ...
                        if self.image_count.value >= 3:
                            ...
                            self.image_capture_queue.put_nowait([message])
    ...
    def _process_capture_pic(self):
        ...
        while True:
            try:
                if not self.image_capture_queue.empty():
                    image_message =  self.image_capture_queue.get_nowait()
